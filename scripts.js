...
function initComponents() {
    ...
    initContainer.appendChild(textFeild)
    ...
    initContainer.appendChild(numberField)
    let nextBtn = document.createElement("input")
    nextBtn.setAttribute("class", "next-btn");
    nextBtn.setAttribute("type", "submit");
    nextBtn.setAttribute("value", "Next-->");
    nextBtn.onclick = validateEnteredNumber;
    initContainer.appendChild(nextBtn);
}
...
function setUpPlayComponents() {
    ...
    arrowUpContainer.onclick = function () {
        let preValue = parseInt(document.getElementById("current-number").innerHTML);
        min = preValue + 1;
    ...
    equalContainer.onclick = function () {
        let expectedValue = parseInt(document.getElementById("current-number").innerHTML)
